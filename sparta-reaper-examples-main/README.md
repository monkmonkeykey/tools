...
**Note that these examples require SPARTA v1.8.0 or later. For examples that work with older versions of the plugins (pre-1.8.0), use version 1.0.0 of the examples found in the "release" section.**.
